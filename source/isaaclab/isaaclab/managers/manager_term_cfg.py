...
class EventTermCfg(ManagerTermBaseCfg):
    ...
    func: Callable[..., None | torch.Tensor] = MISSING
    """The name of the function to be called.
    ...
    """Whether to store the data generated by the term. Defaults to False.

    If True, the function should return a tensor of shape (num_envs, ...) that is stored in the event manager.
    This tensor can be used for privileged information.
    """

    zero_data: bool = False
    """Whether the data should be zeroed if its not updated. Defaults to False. This only has effect on terms
    with mode "interval".
    """
